...
function Loader( editor ) {
		...
		switch ( extension ) {
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { Rhino3dmLoader } = await import( './loaders/3DMLoader.js' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { TDSLoader } = await import( './loaders/TDSLoader.js' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { AMFLoader } = await import( './loaders/AMFLoader.js' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { ColladaLoader } = await import( './loaders/ColladaLoader.js' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { IFCLoader } = await import( './loaders/IFCLoader.js' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { KMZLoader } = await import( './loaders/KMZLoader.js' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { LDrawLoader } = await import( './loaders/LDrawLoader.js' );

					const loader = new LDrawLoader();
					loader.setPath( '../models/ldraw/officialLibrary/' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { MD2Loader } = await import( './loaders/MD2Loader.js' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { SVGLoader } = await import( './loaders/SVGLoader.js' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { VOXLoader, VOXMesh } = await import( './loaders/VOXLoader.js' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { VTKLoader } = await import( './loaders/VTKLoader.js' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { VRMLLoader } = await import( './loaders/VRMLLoader.js' );
...

			{
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { XYZLoader } = await import( './loaders/XYZLoader.js' );
	...
	async function handleZIP( contents ) {
		...
		if ( zip[ 'model.obj' ] && zip[ 'materials.mtl' ] ) {
			...
			const { MTLLoader } = await import( './loaders/MTLLoader.js' );
			const { OBJLoader } = await import( './loaders/OBJLoader.js' );
