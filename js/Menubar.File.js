...
function MenubarFile( editor ) {
	...
	option.onClick( async function () {
		...
		const { ColladaExporter } = await import( './exporters/ColladaExporter.js' );
	...
	option.onClick( async function () {
		...
		const { DRACOExporter } = await import( './exporters/DRACOExporter.js' );
	...
	option.onClick( async function () {
		...
		const { PLYExporter } = await import( './exporters/PLYExporter.js' );
	...
	option.onClick( async function () {
		...
		const { USDZExporter } = await import( './exporters/USDZExporter.js' );
	...
	option.onClick( function () {
		...
		loader.load( '../libs/three.module.js', function ( content ) {

			toZip[ 'js/three.module.js' ] = strToU8( content );

		} );
		loader.load( './webxr/VRButton.js', function ( content ) {
